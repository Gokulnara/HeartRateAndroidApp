...
import com.example.heartrate.pulsesave.api.PulseApiClient;
import com.example.heartrate.pulsesave.api.PulseResponse;
import com.example.heartrate.pulsesave.api.PulseSave;
...
//                    Toast.makeText(HeartRateResult.this,response.body().getMessage(),Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<PulseResponse> call, Throwable t) {
                ...
                Toast.makeText(HeartRateResult.this,t.getMessage(),Toast.LENGTH_LONG);
